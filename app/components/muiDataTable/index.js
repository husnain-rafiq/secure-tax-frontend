...
function CustomNoRowsOverlay() {
  ...
  return (
    <Box py={15} className={classes.alert}>
      <GridOverlay className={classes.layout}>
        <svg
          width="120"
          height="100"
          viewBox="0 0 184 152"
        ...
        <div className={classes.label}>No Record Found</div>
      </GridOverlay>
    </Box>
  );
}
...
export default function DataTable({
  ...
  const onSelectRow = (newSelection) => {
  ...
  const handleChangePage = (params) => {
    ...
    handleServerPageNumber(currentPage + 1);
  };
  return (
